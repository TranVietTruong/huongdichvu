...
class SloganController extends Controller
{
    ...
    public function removeSlogan()
    {
        ...
        if(file_exists("public/upload/slogan/".$image))
        {
            unlink('public/upload/slogan/'.$image);
        }
    ...
    public function updateImage()
    {
        ...
        if(file_exists("public/upload/slogan/".$slogan['image']))
        {
            unlink('public/upload/slogan/'.$slogan['image']);
        }
